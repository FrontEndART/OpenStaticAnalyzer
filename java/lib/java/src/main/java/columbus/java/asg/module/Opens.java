...
public interface Opens extends ModuleDirective {
	...
	/**
	 * Remove the {@link columbus.java.asg.module.Opens#edgeHasPackageName hasPackageName} edge.
	 */
	...
	/**
	 * Remove the {@link columbus.java.asg.module.Opens#edgeHasModuleNames hasModuleNames} edge by id from the node.
	 * @param id The new end point of the hasModuleNames edge.
	 */
	public void removeModuleNames(int id);

	/**
	 * Remove the {@link columbus.java.asg.module.Opens#edgeHasModuleNames hasModuleNames} edge from the node.
