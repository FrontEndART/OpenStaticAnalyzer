...
public interface Erroneous extends Expression {
	...
	/**
	 * Remove the {@link columbus.java.asg.expr.Erroneous#edgeHasErrors hasErrors} edge by id from the node.
	 * @param id The new end point of the hasErrors edge.
	 */
	public void removeErrors(int id);

	/**
	 * Remove the {@link columbus.java.asg.expr.Erroneous#edgeHasErrors hasErrors} edge from the node.
